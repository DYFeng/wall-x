#!/bin/bash
set -x
export PYTHONPATH="/root/gpufree-data/LIBERO:${PYTHONPATH}"
export LIBERO_CONFIG_PATH=/root/gpufree-data/datasets/x-square-robot/libero_all/.libero
# ================= 配置区域 =================
checkpoint_path="/root/gpufree-data/output/train/libero_all/ckpt/0"
mode="flow"
norm_key="x-square-robot/libero_all"
